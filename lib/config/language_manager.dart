  ...
  static final Map<String, Map<String, Map<String, String>>> _translations = {
    'en': {
      ...
      'recipes': {
        ...
        'cured_meat_desc': 'Meat preserved for long-term storage',
        'leather': 'Leather',
        'leather_desc': 'Processed animal hide',
        'steel': 'Steel',
        'steel_desc': 'Iron refined with coal',
        'cloth': 'Cloth',
        'cloth_desc': 'Woven fabric from fur',
        'rope': 'Rope',
        'rope_desc': 'Strong rope made from cloth',
        'medicine': 'Medicine',
        'medicine_desc': 'Healing supplies made from herbs',
        'sword': 'Sword',
        'sword_desc': 'Sharp weapon for combat',
        'armor': 'Armor',
        'armor_desc': 'Protective gear for combat',
        'gunpowder': 'Gunpowder',
        'gunpowder_desc': 'Explosive powder for weapons',
        'bullet': 'Bullet',
        'bullet_desc': 'Ammunition for firearms',
      },
      'save': {
    ...
    'zh': {
      ...
      'recipes': {
        'cured_meat': '熏肉',
        'cured_meat_desc': '将生肉制成可以长期保存的熏肉',
        'leather': '皮革',
        'leather_desc': '将毛皮加工成皮革',
        'steel': '钢',
        'steel_desc': '将铁和煤炼制成钢',
        'cloth': '布料',
        'cloth_desc': '将毛皮制成布料',
        'rope': '绳索',
        'rope_desc': '用布料制作结实的绳索',
        'medicine': '药品',
        'medicine_desc': '用草药制作治疗药品',
        'sword': '剑',
        'sword_desc': '制作一把锋利的剑',
        'armor': '盔甲',
        'armor_desc': '制作一套防护盔甲',
